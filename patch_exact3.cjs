...
if (startR !== -1) {
    ...
    const endR = code.indexOf(mainEndStr, startR);
    if (endR !== -1) {
        // However, I need to keep the </div> that closes lg:col-span-12 which is right before it!
        ...
        // I want to replace everything from startR up to but NOT including "                </div>\n              </div>\n            )}\n"
        const lastDivBeforeMainEnd = code.lastIndexOf("                </div>\n              </div>\n            )}\n", endR);
        code = code.substring(0, startR) + replacementR + code.substring(lastDivBeforeMainEnd);
